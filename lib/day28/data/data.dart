...
List<EventTypeModel> getEventTypes(){
  ...
  //1
  eventModel.imgAssetPath = "assets/event/concert.png";
  ...
  //1
  eventModel.imgAssetPath = "assets/event/sports.png";
  ...
  //1
  eventModel.imgAssetPath = "assets/event/education.png";
...
List<EventsModel> getEvents(){
  ...
  //1
  eventsModel.imgeAssetPath = "assets/event/tileimg.png";
  ...
  //2
  eventsModel.imgeAssetPath = "assets/event/second.png";
  eventsModel.date = "Jan 12, 2019";
  ...
  //3
  eventsModel.imgeAssetPath = "assets/event/music_event.png";
  eventsModel.date = "Jan 12, 2019";
  eventsModel.address = "Galaxyfields, Sector 22, Faridabad";
